...
export const player_state = (() => {
  ...
  class DeathState extends State {
    ...
    Update(timeElapsed) {
      if (this._action) {
        this._action.getMixer().update(timeElapsed);
      }
    }
  };
  ...
  class WalkState extends State {
    ...
    Update(timeElapsed, input) {
      if (this._parent._proxy._animations['walk'].action) {
        this._parent._proxy._animations['walk'].action.getMixer().update(timeElapsed);
      }
  ...
  class RunState extends State {
    ...
    Update(timeElapsed, input) {
      if (this._parent._proxy._animations['run'].action) {
  ...
  class IdleState extends State {
    ...
    Update(timeElapsed, input) {
      if (this._parent._proxy._animations['idle'].action) {
